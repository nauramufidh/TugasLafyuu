...
class Home : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val splashImageView1 = view.findViewById<ImageView>(R.id.imageView9)
        ...
        val splashImageView2 = view.findViewById<ImageView>(R.id.imageView5)
        ...
        val splashImageView3 = view.findViewById<ImageView>(R.id.sepatumerah)
        splashImageView3.setOnClickListener {
            // Tindakan yang ingin dilakukan saat gambar diklik
            // Misalnya, pindah ke aktivitas lain
